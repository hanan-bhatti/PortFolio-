  ...
  return (
    <>
      <button
        ...
        disabled={isPending}
        className="rounded-none border border-red-500/30 bg-red-500/5 px-2.5 py-1 sm:px-4 sm:py-2 font-mono text-[10px] sm:text-xs font-bold uppercase tracking-widest text-red-500 hover:border-red-500 hover:bg-red-500/15 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer shrink-0"
      >
        {isPending ? (
          "Clearing..."
        ) : (
          <>
            <span className="hidden sm:inline">Clear Analytics Data</span>
